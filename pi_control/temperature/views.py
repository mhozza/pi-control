    ...
    return Response(
        {
            "time": now,
            "device": device_id,
            "temperature": {"value": temperature, "high": temperature_high, "low": temperature_low},
            "humidity": {"value": humidity, "high": humidity_high, "low": humidity_low},
        }
    )
        ...
        return Response(
            {
                ...
                "humidity": {"value": avg_humidity, "high": humidity_high, "low": humidity_low},
...
class TemperatureListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        return Entry.objects.filter(
            time__range=(time_from, time_to), device=self.request.GET.get("device", DEFAULT_DEVICE)
        ).order_by("time")
